...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				...
				array('label'=>'System Folder Upload','url'=>Yii::app()->createUrl('/sFileBrowser/systemFolderAdmin'),'visible'=>Yii::app()->user->name == 'admin','active'=>true),
...
$this->widget('ext.elFinder.ElFinderWidget', array(
        'connectorRoute' => 'sFileBrowser/connectorSystemFolderAdmin',
        )
);
