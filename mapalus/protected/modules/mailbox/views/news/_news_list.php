...
<tr
	...
	<td width="25"><div class="mailbox-item-wrapper mailbox-drag">&nbsp;</div>
	</td>
	<?php endif; ?>

	<?php if( $this->module->isAdmin() ) : ?>
	<td width="25"><label class="ui-helper-reset"
		for="conv_<?php echo $data->conversation_id; ?>">
	...
	<td class="mailbox-subject-brief">
		<div class="mailbox-item-wrapper mailbox-subject mailbox-ellipsis">
			<span class="mailbox-subject-text"><a class="mailbox-link"
				title="<?php echo $status; ?>" href="<?php echo $viewLink; ?>"><?php echo preg_replace('/[\s]+/','&nbsp;',(($data->subject)? $data->subject : $this->module->defaultSubject)); ?>
			</a> </span><span class="mailbox-msg-brief">&nbsp;-&nbsp;<?php echo preg_replace('/[\s]+/','&nbsp;',substr($data->text,0,50)); ?>
			</span>
		</div>
	</td>
