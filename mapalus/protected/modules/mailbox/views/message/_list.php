...
if($username && ($this->module->isAdmin() || $this->module->linkUser)) {
	...
	$url = $this->createUrl("/sUser/viewPublic",array("id"=>$counterUserId));
	if($url)
...
<tr
	...
	<td width="25" style="width: 50px;"><div
			class="mailbox-item-wrapper mailbox-drag">&nbsp;</div></td>
	<?php endif; ?>

	<td width="25" style="width: 450px;"><?php if($this->getAction()->getId()=='sent') : ?>
		<div class="mailbox-item-wrapper">&nbsp;</div> <?php else: ?>
		<div class="mailbox-item-wrapper">
			<label class="ui-helper-reset"
	...
	<td width="150" class="mailbox-received">
		<div align="right" class="mailbox-item-wrapper" style="width: 100px">
