...
<div class="row-fluid">
	...
	<div class="span10 mailbox-message-list">
		<?php
		...
		?>
		<div class="mailbox-message-subject  mailbox-ellipsis">
			<?php echo $subject; ?>
		</div>
		...
		<div class="mailbox-message-header">
			...
			<div class="message-date">
				<?php echo date("Y-m-d H:i a",$msg->created); ?>
			</div>
			<br />
		</div>
		...
		<div class="mailbox-message-reply">
			...
			<input type="submit" class="btn btn-large mailbox-input"
				value="Send Reply" />
		</div>
