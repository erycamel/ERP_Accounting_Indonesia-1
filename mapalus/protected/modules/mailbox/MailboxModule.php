...
class MailboxModule extends CWebModule
{
	...
	*/
	const TBL_CONV = 's_mailbox_conversation';
	const TBL_MSG = 's_mailbox_message';
	...
	*/
	...
	public function registerScripts()
	{
		...
		$this->_cs->registerCssFile(Yii::app()->getClientScript()->getCoreScriptUrl().'/jui/css/2jui-bootstrap/jquery-ui.css');
