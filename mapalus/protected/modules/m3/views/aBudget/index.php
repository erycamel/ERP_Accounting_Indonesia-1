		...
		<?php $this->widget('bootstrap.widgets.BootButtonGroup', array(
				...
				'buttons'=>array(
						array('label'=>'Project', 'items'=>array(
								...
								array('label'=>'C-06 RMG/ MGR', 'url'=>Yii::app()->createUrl("/m3/aBudget/index",array("id"=>300,"pro_id"=>2))),
								'---',
								array('label'=>'C-07 CP', 'url'=>Yii::app()->createUrl("/m3/aBudget/index",array("id"=>1001))),
						)),
				),
		)); ?>
