<?php $this->widget('bootstrap.widgets.BootGridView', array(
		...
		'columns'=>array(
				...
				array (
						...
						'value'=>'CHtml::link($data->name,Yii::app()->createUrl("/m3/aBudget",array("id"=>$data->id,"pro_id"=>$data->department_id)))',
				),
				array (
						'header'=>'Parent',
						'type'=>'raw',
						...
						'value'=>'($data->getparent) ? CHtml::link($data->getparent->name,Yii::app()->createUrl("/m3/aBudget",array("id"=>$data->getparent->parent_id))) : ""',
				),
				//'unit',
				array(
						'name'=>'amount',
