...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				array('label'=>'Waiting for Approval','url'=>Yii::app()->createUrl('/m3/aApprovalForm',array("id"=>1)),'active'=>($id==1)),
				array('label'=>'Waiting for Payment','url'=>Yii::app()->createUrl('/m3/aApprovalForm',array("id"=>2)),'active'=>($id==2)),
				array('label'=>'Paid','url'=>Yii::app()->createUrl('/m3/aApprovalForm',array("id"=>3)),'active'=>($id==3)),
				array('label'=>'Show All','url'=>Yii::app()->createUrl('/m3/aApprovalForm',array("id"=>0)),'active'=>($id==0)),
		),
));
?>
<?php
