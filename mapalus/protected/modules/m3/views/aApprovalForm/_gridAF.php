...
<?php $this->widget('bootstrap.widgets.BootGridView', array(
		...
		'columns'=>array(
				array(
						...
						(
								...
								(
										...
										'url'=>'Yii::app()->createUrl("/m3/aApprovalForm/updateApproved", array("id"=>$data->id))',
								...
								(
										'label'=>'Paid',
										//'imageUrl'=>Yii::app()->request->baseUrl.'/images/icon/process.png',
										'url'=>'Yii::app()->createUrl("/m3/aApprovalForm/updatePaid", array("id"=>$data->id))',
				...
				array(
						...
						(
								...
								(
										'label'=>'Print AF ',
										//'imageUrl'=>Yii::app()->request->baseUrl.'/images/icon/process.png',
										'url'=>'Yii::app()->createUrl("/m3/aApprovalForm/report1", array("id"=>$data->id))',
										'visible'=>'(!isset($data->approved_date))',
										'options'=>array(
												'class'=>'btn btn-mini',
										),
				...
				array(
						...
						(
								...
								(
										...
										//'imageUrl'=>Yii::app()->request->baseUrl.'/images/icon/process.png',
										'url'=>'Yii::app()->createUrl("/m3/aApprovalForm/report2", array("id"=>$data->id))',
										'visible'=>'(!isset($data->approved_date))',
										'options'=>array(
												'class'=>'btn btn-mini',
										),
				...
				array(
						'name'=>'no_ref',
						'type'=>'raw',
						'value'=>'CHtml::link($data->no_ref,Yii::app()->createUrl("/m3/aApprovalForm/view",array("id"=>$data->id)))',
				),
				'periode_date',
				array(
						'header'=>'BudgetComp',
