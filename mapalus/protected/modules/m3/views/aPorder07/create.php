...
$this->breadcrumbs=array(
		...
		array('label'=>'Home', 'url'=>array('/m3/aPorder07')),
...
<div class="page-header">
	<h1>
		...
		New PO <small>Create new PO C-07</small>
	</h1>
</div>
...
<?php echo $form->dropDownListRow($model,'budgetcomp_id',aBudget::mainComponent07(),array(
//	'ajax'=>array(
