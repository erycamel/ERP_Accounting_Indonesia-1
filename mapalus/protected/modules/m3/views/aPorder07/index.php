...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				array('label'=>'Waiting for Approval','url'=>Yii::app()->createUrl('/m3/aPorder07',array("id"=>1)),'active'=>($id==1)),
				array('label'=>'Waiting for Payment','url'=>Yii::app()->createUrl('/m3/aPorder07',array("id"=>2)),'active'=>($id==2)),
				array('label'=>'Paid','url'=>Yii::app()->createUrl('/m3/aPorder07',array("id"=>3)),'active'=>($id==3)),
				array('label'=>'Show All','url'=>Yii::app()->createUrl('/m3/aPorder07',array("id"=>0)),'active'=>($id==0)),
		),
));
?>
...
<?php $this->widget('bootstrap.widgets.BootGridView', array(
		'id'=>'aPorder-grid',
		'dataProvider'=>aPorder::model()->search07($id),
		//'filter'=>$model,
		...
		'columns'=>array(
				...
				array(
						'name'=>'no_ref',
						'type'=>'raw',
						'value'=>'CHtml::link($data->no_ref,Yii::app()->createUrl("/m3/aPorder07/view",array("id"=>$data->id)))',
				),
				'periode_date',
				array(
