...
$this->widget('bootstrap.widgets.BootMenu', array(
		...
		'items'=>array(
				array('label'=>'Waiting for Approval','url'=>Yii::app()->createUrl('/m2/mAccpayable',array("id"=>1)),'active'=>($id==1)),
				array('label'=>'Waiting for Payment','url'=>Yii::app()->createUrl('/m2/mAccpayable',array("id"=>2)),'active'=>($id==2)),
				array('label'=>'Paid','url'=>Yii::app()->createUrl('/m2/mAccpayable',array("id"=>3)),'active'=>($id==3)),
				array('label'=>'Show All','url'=>Yii::app()->createUrl('/m2/mAccpayable',array("id"=>0)),'active'=>($id==0)),
		),
));
?>
...
<?php $this->widget('bootstrap.widgets.BootGridView', array(
		...
		'columns'=>array(
				...
				array(
						'header'=>'Supplier',
						'type'=>'raw',
						'value'=>'CHtml::link($data->supplier->company_name,Yii::app()->createUrl("/m2/mAccpayable/viewSupplier",array("id"=>$data->supplier_id)))',
				),
				'input_date',
				array(
						'name'=>'system_ref',
				...
				array(
						...
						(
								...
								(
										...
										'url'=>'$this->grid->controller->createUrl("/m2/mAccpayable/view", array("id"=>$data->id,"asDialog"=>1,"gridId"=>$this->grid->id))',
